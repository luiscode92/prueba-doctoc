...
import { fetchAppointment } from '@/redux2/features/appointmentSlice';
import { useAppDispatch, useAppSelector } from '@/redux2/hooks';

interface PatientCardProps {
    appointmentId: string;
}
const PatientCard:React.FC<PatientCardProps> = ({appointmentId })=> {
    ...
    useEffect(() => {
        try {
            // Trigger the fetchAppointment action to retrieve the appointment details
